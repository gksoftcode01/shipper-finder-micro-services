...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("ai.yarmook.shipperfinderms.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("ai.yarmook.shipperfinderms.security.DomainUserDetailsService", "createSpringSecurityUser");
